...
export default class NewTopic extends Component {
  ...
  onChangImageURL(e) {
    ...
    for (let index = 0; index < img.length; index++) {
      html += `<img src="${URL.createObjectURL(
        img[index]
          ...
          <div className="form-row">
            <div className="form-group col-md-4">
              ...
              <div className="d-flex">
                <select
                  id="inputState"
                  className="form-control"
                  value={this.state.address_pri}
                  onChange={this.onChangeAddress_Pri}
                >
                  <option></option>
                ...
                <input
                  value={this.state.address_sec}
                  onChange={this.onChangeAddress_Sec}
                  className="form-control"
                />
              </div>
            </div>
            <div className="form-group col-md-3">
              ...
              <input
                ...
                className="form-control"
                id="coorx"
                value={this.state.coorx}
                onChange={this.onChangeCoorX}
              />
            </div>
            <div className="form-group col-md-3">
              <label>Coor-y</label>
              <input
                ...
                className="form-control"
                id="coory"
                value={this.state.coory}
                onChange={this.onChangeCoorY}
              />
            </div>
            <div className="form-group">
              ...
              <input
                ...
                multiple
              />
              <div className="img-preview" id="img-preview"></div>
            </div>
          </div>
